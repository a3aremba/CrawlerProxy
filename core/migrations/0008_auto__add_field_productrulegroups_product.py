...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductRuleGroups.product'
        db.add_column(u'core_productrulegroups', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Product'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductRuleGroups.product'
        db.delete_column(u'core_productrulegroups', 'product_id')
    ...
    models = {
        ...
        'core.productrule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ProductRuleGroups']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
